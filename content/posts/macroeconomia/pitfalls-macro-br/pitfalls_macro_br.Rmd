...
author: "Fernando da Silva, Economista"
...
```{r, echo=FALSE, fig.cap="Fonte: Calvin and Hobbes by Bill Watterson for August 23, 1995"}
knitr::include_graphics("imgs/Calvin_Hobbes_Data_Quality.png")
```
