...
- Uma conta do GitHub criada: [https://github.com](https://github.com);
- R e RStudio instalados ([tutorial](https://happygitwithr.com/install-r-rstudio.html));
- Git instalado ([tutorial](https://happygitwithr.com/install-git.html)).
...
- Acesse [https://github.com/settings/tokens](https://github.com/settings/tokens) e clique em "*Generate new token*", selecionando os escopos desejados (recomenda-se selecionar *repo, user,* e *workflow*)
...
Acesse [https://github.com](https://github.com) e certifique-se de estar conectado. Próximo de “Repositories”, clique no botão verde “New”. Na nova página preencha o nome do repositório e descrição (use sua criatividade). Marque as opções *Public* e *Add a README file* e, por fim, clique em "Create repository".
