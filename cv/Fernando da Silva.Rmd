...
# About me
I am a data scientist specialized in economics and finance. I have 4+ years of experience working with data, time series models, econometrics, machine learning, ETL process, EDA and visualization, including reports and dashboards. I have 3+ years of real-world experience implementing projects and developing products using R, Python, Git, and GitHub.

I am curious, adaptable, and focused. I am always open to new challenges and I really enjoy creating new things.
...
am <- tibble(
  ...
  where   = "",
  details = c(
    "Development of predictive models using statistics, econometrics and machine learning for 13 Brazilian macroeconomic variables;",
    "Development, deployment, and monitoring of 4 time series predictive models;",
    "Development of reports and dashboards using Quarto, R Markdown, Shiny, and Plotly Dash;",
    "Development of R packages and release of the {nucleos} package for core inflation analysis;",
    "Development of ETL processes working with larger-than-memory datasets using R, Python, and SQL;",
    "Development of web scraping for various static and dynamic pages using R, RSelenium, {httr2}, and others;",
    "Macroeconomic analysis of Brazilian data using macroeconomic models such as the IS curve, Phillips curve, and Taylor rule;",
    ...
    "Classes and courses on predictive models, econometrics, forecasting, macroeconomics, time series analysis, dashboards, reports, programming with R, Python, SQL, and others."
    )
  )
...
banri <- tibble(
  ...
  dates   = paste0("Jan 2018 - Dec 2019", time("2018-01-01", "2019-12-01")),
  where   = "",
  details = c(
